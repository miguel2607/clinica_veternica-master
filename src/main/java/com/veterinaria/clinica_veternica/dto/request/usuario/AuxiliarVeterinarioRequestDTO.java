...
/**
 * DTO de Request para crear/actualizar un AuxiliarVeterinario.
...
@AllArgsConstructor
@Builder
public class AuxiliarVeterinarioRequestDTO {
    ...
    // Datos específicos de AuxiliarVeterinario
    /**
     * Nivel de certificación del auxiliar.
     * Ejemplos: Básico, Intermedio, Avanzado
     */
    @Size(max = 50, message = "El nivel de certificación no puede exceder 50 caracteres")
     ...
     */
    @Size(max = 200, message = "Las áreas de especialización no pueden exceder 200 caracteres")
